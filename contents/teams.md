...
> ※プラン名は変更されることがあるため、最新の提供状況は Terraform Cloud の[料金ページ](https://www.hashicorp.com/ja/pricing)で確認してください。

Team に対する権限は Organization レベルと Workspace レベルの 2 段階で設定できます。

ここでのエクササイズでは、Team を作成し Organization および Workspace にマッピングして、アクセス権限を付与してみます。
